...
const introduction = {
  text: [
    ...
    "My name is Aashish, I'm from Indore and I'm currently studying IT at IIIT Gwalior. I am a web developer.",

    "Outside of my regular activities, I'm with my friends whenever I have some free time. I also enjoy playing cricket and football for fun.",
...
const skills = [
  ...
  },
  {
    ...
    icon: javaIcon,
    description:
      'I am familiar with Java and have some experience in object-oriented programming (OOP) and basic implementation of data structures.',
  },
  {
    id: 'aws',
